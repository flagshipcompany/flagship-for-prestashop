...
class AvailableServicesCollectionTests extends TestCase{
    ...
    public function testGetServicesByCourier(){
        ...
        $this->assertInstanceOf(AvailableServicesCollection::class, $this->servicesCollection->getServicesByCourier('purolator'));
    }

    public function testGetStandardServicesByCourier(){
        $this->assertNotEmpty($this->servicesCollection->getStandardServicesByCourier('canpar'));
        $this->assertNotNull($this->servicesCollection->getStandardServicesByCourier('ups'));
        $this->assertInstanceOf(AvailableServicesCollection::class, $this->servicesCollection->getStandardServicesByCourier('purolator'));
        $this->assertSame(2,count($this->servicesCollection->getStandardServicesByCourier('fedex')));
    }
    ...
    public function testGetStandardServices(){
        $this->assertNotEmpty($this->servicesCollection->getStandardServices());
        $this->assertNotNull($this->servicesCollection->getStandardServices());
        $this->assertInstanceOf(AvailableServicesCollection::class, $this->servicesCollection->getStandardServices());
        $this->assertSame(8,count($this->servicesCollection->getStandardServices()));
    }

    public function testGetExpressServices(){
        $this->assertNotEmpty($this->servicesCollection->getExpressServices());
        $this->assertNotNull($this->servicesCollection->getExpressServices());
        $this->assertInstanceOf(AvailableServicesCollection::class, $this->servicesCollection->getExpressServices());
        $this->assertSame(61,count($this->servicesCollection->getExpressServices()));
    }

    public function testGetOvernightServices(){
        $this->assertNotEmpty($this->servicesCollection->getOvernightServices());
        $this->assertNotNull($this->servicesCollection->getOvernightServices());
        $this->assertInstanceOf(AvailableServicesCollection::class, $this->servicesCollection->getOvernightServices());
