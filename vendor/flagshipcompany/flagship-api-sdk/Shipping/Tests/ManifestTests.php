...
class ManifestTests extends TestCase{
    ...
    public function testGetToDepotShipment(){
        ...
        $this->assertSame(3372195, $this->manifest->getToDepotShipment()->getId());
    }
    ...
    public function testGetPriceByShipmentId(){
        $this->assertNotNull($this->manifest->getPriceByShipmentId(3372192));
        $this->assertSame(19.92,$this->manifest->getPriceByShipmentId(3372193)->getTotal());
    }
    ...
    public function testGetTaxesDetails(){
        ...
        $this->assertSame(["gst"=> 2.75,
                "qst"=> 5.470000000000001,
                "hst"=> 6.56], $this->manifest->getTaxesDetails());
    }
    ...
    protected function setup() : void {
        ...
        "to_depot_shipment": {
            ...
            "documents": {
                "regular_label": "http://192.168.188.74:3002/ship/3372195/labels/e5a146e501b543fd6de1c7289ce511f78c6d960c?document=reg",
                "thermal_label": "http://192.168.188.74:3002/ship/3372195/labels/e5a146e501b543fd6de1c7289ce511f78c6d960c?document=therm"
            },
            "transit_details": [
                {
                    "status": "M",
    ...
    $this->manifest = $this->getMockBuilder(Manifest::class)
